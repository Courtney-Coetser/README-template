...
*** Reference links should be enclosed in brackets [ ] instead of parentheses ( ).
...
`github_username`, `repo_name`, `twitter_handle`, `linkedin_username`, `email_client`, 
`email`, `project_title`, `project_description`
...
<!-- CONTACT -->
## Contact
Courtney C. Coetser - [@c_coetser](https://twitter.com/twitter_handle) - email@email_client.com
